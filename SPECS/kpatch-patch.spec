...
%changelog
* Wed Oct 27 2021 Artem Savkov <asavkov@redhat.com> [1-6.el8]
...
* Wed Sep 01 2021 Artem Savkov <asavkov@redhat.com> [1-5.el8]
- powerpc: KVM guest OS users can cause host OS memory corruption [1988230] {CVE-2021-37576}

* Tue Jul 27 2021 Artem Savkov <asavkov@redhat.com> [1-4.el8]
...
* Mon Jul 12 2021 Artem Savkov <asavkov@redhat.com> [1-3.el8]
